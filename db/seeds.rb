...
Criterium.create(id: 27, number: 1, name: 'มีจำนวนครั้งที่ไม่แสดงตัวตนในระบบ GPS (ครั้ง)', criteria_group_id: 6,weight: 3.75)
Criterium.create(id: 28, number: 2, name: 'จำนวนครั้งที่ใช้ความเร็วเกิน (ครั้ง/คัน)', criteria_group_id: 6,weight: 3.75)
Criterium.create(id: 29, number: 3, name: 'ความเร็วสูงสุดที่ขับขี่ (km/h)', criteria_group_id: 6,weight: 3.75)
Criterium.create(id: 30, number: 4, name: 'ข้อมูลอุบัติเหตุของรถโดยสารสาธารณะ ทั่วประเทศ ย้อนหลัง 12 เดือน (ข้อมูลตลอดปี 2561) >> อุบัติเหตุทั่วไป', criteria_group_id: 6,weight: 3.75)

Criterium.create(id: 31, number: 1, name: 'ไม่เคยเกิดอุบัติเหตุร้ายแรงของรถโดยสารสาธารณะภายใน 12 เดือนที่ผ่านมา', criteria_group_id: 7,weight: 0)
Criterium.create(id: 32, number: 2, name: 'มีแผนการตรวจสภาพและบำรุงรักษา และดำเนินการอย่างเหมาะสม อย่างน้อยปีละ 2 ครั้ง', criteria_group_id: 7,weight: 0)
Criterium.create(id: 33, number: 3, name: 'การชำระภาษีรถทุกคัน', criteria_group_id: 7,weight: 0)
Criterium.create(id: 34, number: 4, name: 'มีการติดตั้ง GPS ทุกคัน', criteria_group_id: 7,weight: 0)
Criterium.create(id: 35, number: 5, name: 'มีการตรวจความพร้อมของพนักงานขับรถก่อนปฏิบัติงานทุกครั้ง (เช่น ระดับแอลกอฮอล์และสารเสพติด)', criteria_group_id: 7,weight: 0)

Criterium.create(id: 36, number: 1, name: 'เดินรถตามเส้นทางตามที่กำหนดในใบอนุญาต', criteria_group_id: 8,weight: 0)
Criterium.create(id: 37, number: 2, name: 'จำนวนรถที่มีอยู่จริง ตรงตามเงื่อนไขจำนวนรถขั้นสูง-ขั้นต่ำ', criteria_group_id: 8,weight: 0)
Criterium.create(id: 38, number: 3, name: 'จำนวนเที่ยวเดินรถจริงเฉลี่ยต่อวัน ไม่น้อยกว่าจำนวนเที่ยวการเดินรถขั้นต่ำ', criteria_group_id: 8,weight: 0)
Criterium.create(id: 39, number: 4, name: 'เก็บอัตราค่าโดยสารตามที่กำหนด', criteria_group_id: 8,weight: 0)
Criterium.create(id: 40, number: 5, name: 'เวลาทำงานประจำวันในการประกอบการขนส่ง', criteria_group_id: 8,weight: 0)

Criterium.create(id: 41, number: 1, name: 'ไม่เคยเกิดอุบัติเหตุร้ายแรงของรถโดยสารสาธารณะภายใน 12 เดือนที่ผ่านมา', criteria_group_id: 9,weight: 0)
Criterium.create(id: 42, number: 2, name: 'เดินรถตามเส้นทางตามที่กำหนดในใบอนุญาตประกอบการเดินรถ', criteria_group_id: 9,weight: 0)
Criterium.create(id: 43, number: 3, name: 'จำนวนรถที่มีอยู่จริง ตรงตามเงื่อนไขจำนวนรถขั้นต่ำ-ขั้นสูง', criteria_group_id: 9,weight: 0)
Criterium.create(id: 44, number: 4, name: 'จำนวนเที่ยวเดินรถจริงเฉลี่ยต่อวัน ไม่น้อยกว่าจำนวนเที่ยวการเดินรถขั้นต่ำ', criteria_group_id: 9,weight: 0)
Criterium.create(id: 45, number: 5, name: 'เวลาเดินรถเที่ยวแรก-เที่ยวสุดท้ายตรงตามที่กำหนดในใบอนุญาตประกอบการขนส่ง', criteria_group_id: 9,weight: 0)
Criterium.create(id: 46, number: 6, name: 'เก็บค่าโดยสารตามอัตราที่กำหนด', criteria_group_id: 9,weight: 0)
Criterium.create(id: 47, number: 7, name: 'มีการชำระภาษีรถทุกคัน', criteria_group_id: 9,weight: 0)
Criterium.create(id: 48, number: 8, name: 'มีการติดตั้ง GPS และเชื่อมต่อข้อมูลกับกรมการขนส่งทางบกทุกคัน', criteria_group_id: 9,weight: 0)
Criterium.create(id: 49, number: 9, name: 'สถานที่เก็บ ซ่อม และบำรุงรักษารถโดยสาร มีความเหมาะสมและเพียงพอ', criteria_group_id: 9,weight: 0)
Criterium.create(id: 50, number: 10, name: 'มีการตรวจความพร้อมของพนักงานขับรถก่อนปฏิบัติงานทุกครั้ง (เช่น ระดับแอลกอฮอล์และสารเสพติด)', criteria_group_id: 9,weight: 0)
Criterium.create(id: 51, number: 11, name: 'กำหนดจุดพักรถและที่พักสำหรับพนักงานขับรถระหว่างเส้นทางขนส่งอย่างเหมาะสม', criteria_group_id: 9,weight: 0)
...
Evidence.create(id: 11, name: 'รายงานสรุปผลการปฏิบัติงาน หรือ รายงานสำหรับผู้บริหารที่แสดงประสิทธิผลการดำเนินงาน')
