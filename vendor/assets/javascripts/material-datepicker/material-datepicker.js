...
var MaterialDatepicker = function() {
    ...
    return _createClass(c, [{
        ...
        value: function(t) {
            ...
            r.setAttribute("class", "mp-picker-site-before-year mp-picker-site-button"), o.appendChild(r), r.addEventListener("click", function() {
                e._siteChange(-12)
            });
            var ry = document.createElement("a");
            ry.setAttribute("class", "mp-picker-site-before mp-picker-site-button"), o.appendChild(ry), ry.addEventListener("click", function() {
                e._siteChange(-1)
            });
            ...
            py.setAttribute("class", "mp-picker-site-next-year mp-picker-site-button"), o.appendChild(py), py.addEventListener("click", function() {
                e._siteChange(12)
            });
